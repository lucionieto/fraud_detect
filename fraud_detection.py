...
st.title('Fraud detection prediction on streamlit')

st.markdown('Enter the transaction details and use predict button')
...
if st.button('Predict'): 
    ...
    if prediction ==1: 
        st.error('This transaction is flagged as fraud')
    else: 
